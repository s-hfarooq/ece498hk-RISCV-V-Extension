...
TB_SRCS := $(PWD)/tb/qspi_stub.sv $(PWD)/tb/full_tb.sv
...
VCS_FLAGS = -full64 -lca -sverilog -timescale=1ns/10ps -debug -kdb -fsdb +liborder +libverbose +incdir+$(PWD)/src/vicuna/ibex/vendor/lowrisc_ip/ip/prim/rtl +incdir+$(PWD)/src/vicuna/ibex/vendor/lowrisc_ip/dv/sv/dv_utils -assert svaext
